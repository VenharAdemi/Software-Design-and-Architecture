...
// Initialize the number of items displayed per page
let PageSize = 10;
...
// Function to get and parse data from a CSV file and store it in an array
...
// Initialize an array to store hospital data
let hospitals = [{
  id: 1,
  latitude: 1,
  longitude: 1,
...
// Call the function to retrieve and parse data from the CSV file
GetData();

// Function to calculate the distance between two points on a map
...
// React component to display a table of hospitals and sort them by distance from the user's location (if available)
function List(){
